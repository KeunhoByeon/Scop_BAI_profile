...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', default=0.00001 * 4 / 2, type=float, metavar='LR', help='initial learning rate', dest='lr')
    ...
    parser.add_argument('--result', default='results_hs_one_layer', metavar='DIR', help='path to results')
